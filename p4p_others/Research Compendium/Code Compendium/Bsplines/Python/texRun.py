...
if field:
    ...
    # read in NL optimised surface
    newPhi = genfromtxt(NLPhiFile, delimiter=',')

# texture projection
if project:
    # read in camera paramters. Get these by running readcamparams.py
    ...
    # get points to world coordinates
    ...
    # normalise projection using knn
